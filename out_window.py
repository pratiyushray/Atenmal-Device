...
class Ui_OutputDialog(QDialog):
    ...
    def sendmail(self):
        ...
        try:
            ...
            yag.send(to='testmail999123484@gmail.com', subject='Attendence', contents='Please find the image attached', attachments='Attendance.csv')
    ...
    def face_rec_(self, frame, encode_list_known, class_names):
        ...
        for encodeFace, faceLoc in zip(encodes_cur_frame, faces_cur_frame):
            ...
            if self.sendmailbutton.isChecked():
                #self.sendmailbutton.setEnabled(False)
                self.sendmailbutton.clicked.connect(self.sendmail)
                self.sendmailbutton.setChecked(False)
                print("mail started")
